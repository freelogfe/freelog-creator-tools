...
import { IToolbarConfig, IEditorConfig, Boot, IModuleConf, IDomEditor, DomEditor } from "@wangeditor/editor";
...
import { htmlToResourceConfig, renderResourceConfig, resourceToHtmlConfig } from "../custom/dom/resource";
...
export const editorConfig: Partial<IEditorConfig> = {
  hoverbarKeys: {
    ...
    table: {
      menuKeys: ["tableHeader", "insertTableRow", "deleteTableRow", "insertTableCol", "deleteTableCol", "deleteTable"],
    },
    video: { menuKeys: [] },
    text: {
      menuKeys: [
